...
ADDED: token tracking + cost accumulation written to st.session_state["_llm_usage_log"]
"""
...
def _llm_call(prompt: str, max_tokens: int = 300, call_purpose: str = "general") -> str:
    ...
    try:
        ...
        from config.settings import LLM_COST_LOG_PATH  # keep for now if still used elsewhere
